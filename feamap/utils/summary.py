...
class Summary:
    ...
    def _statistics_one(self, data, i):
        # Summarize one feature column after removing NaN and inf values.
        onefeat = data[:,i]
    ...
    def fit(self, data, backend = 'threading', **kwargs):
        ...
        # Parallelize across feature dimensions because each column is independent.
...
def Summary2(data, n_jobs):
    # Multiprocess variant kept for large arrays when the simple joblib path is not enough.
    global DATA, _func
    DATA = data
