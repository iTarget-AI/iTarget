...
# Toggle the target benchmark here before running the preprocessing script.
type = 'bindingdb'
# type = 'human'
# type ='biosnap'
# type = 'chembl'
...
# Assign stable internal IDs so downstream feature extraction and split files can join reliably.
...
if type=='bindingdb':
    # Preserve the official BindingDB train/dev/test partition as processed index files.
